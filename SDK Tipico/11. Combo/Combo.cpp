/*
    ...
    Funcionalidad: Imprime una lista de listas en combos separados por
    decenas en un cuadro de diálogo
    Métodos: GetDlgItem, CreateWindow, GetClientRect, GetWindowRect
    Handles:
    Mensajes:
    Tipos:
    Estructuras:
